...
$(document).ready(function(){
    ...
    for(let i=1;i<=100;i++){
        ...
        let colomn=$(`<div class="column-name colId-${i}" id="colCod-${ans}">${ans}</div>`);
        $(".column-name-container").append(colomn);
    ...
    $(".input-cell").click(function(e){
        ...
        let col=$(this).attr("data").split("-")[1];
        let ans=col+row;
        $(".selected-cell").html(ans);   


        document.getElementsByClassName("selected-cell").innerHTML = ans;
    ...
    function changeHeader(ele){
        ...
        $(".text-color-picker").val(cellInfo["text-color"]);
            ...
            $(".sheet-delete").click(function(){
                if(Object.keys(cellData).length>1){
                    ...
                    if(currSheetIndex == 0){
                        ...
                        selectedSheet=Object.keys(cellData)[currSheetIndex+1];
                    }
                    else{
